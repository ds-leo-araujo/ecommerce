...
$app->post("/register", function(){
	...
	if (User::checkLoginExist($_POST['email']) === true) {
		...
		User::setErrorRegister("Este endereço de e-mail já está sendo usado por outro usuário. Entre com outro e-mail válido.");
		header("Location: /login");
		exit;
	}
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["endereco1"] = utf8_encode($order->gerdesaddress()) . " " . utf8_encode($order->getdesdistrict());
...
$app->post("/profile/change-password", function(){
	...
	{
		User::setError("A confirmação da senha difere da nova senha informada.");
		header("Location: /profile/change-password");
		exit;
	}
